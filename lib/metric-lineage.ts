...
export const METRIC_LINEAGE: Record<string, LineageEntry> = {
  ...
  qm_agendada: {
    ...
    filter: "deal de empresa asistente + post-fecha del evento + origen_negocio compatible",
    update: "Cron 4h",
    note: "Empresa Presencial ↔ origen 'Evento Presencial MKT'. Virtual ↔ 'Webinars MKT'. Atribución incompleta — gap del 54% medido 2026-05-04.",
  },
  qm_asistida: {
    label: "QM Asistida",
    flow: ATTIO_DEALS_FLOW,
    table: "fm_deals_by_event",
    column: "stage = 'Llamada de Calificación de la oportunidad (QM)'",
    filter: "empresa asistió + post-fecha + origen_negocio compatible",
    update: "Cron 4h",
    note: "Mismo filtro que QM Agendada pero el deal ya pasó a stage QM (asistió a la llamada).",
  },
  demo: {
    label: "Demo",
    flow: ATTIO_DEALS_FLOW,
    table: "fm_deals_by_event",
    column: "stage LIKE 'Demostración%'",
    filter: "empresa asistió + post-fecha + origen_negocio compatible",
    update: "Cron 4h",
  },
  won: {
  ...
  qm_asistida_pauta: {
    ...
    flow: ATTIO_DEALS_FLOW,
    table: "fm_deals_by_event",
    column: "qm_asistida filtrado por utm_id IS NOT NULL",
    update: "Cron 4h",
    note: "Mismo caveat: solo deals nuevos post-2026-04-26.",
  },
  demo_pauta: {
    label: "Demo (pauta)",
    flow: ATTIO_DEALS_FLOW,
    table: "fm_deals_by_event",
    column: "demo filtrado por utm_id IS NOT NULL",
    update: "Cron 4h",
    note: "Mismo caveat: solo deals nuevos post-2026-04-26.",
  },
  won_pauta: {
    ...
    flow: ATTIO_DEALS_FLOW,
    table: "fm_deals_by_event",
    column: "won filtrado por utm_id IS NOT NULL",
    update: "Cron 4h",
    note: "Mismo caveat: solo deals nuevos post-2026-04-26.",
  },
  mrr_won_pauta: {
