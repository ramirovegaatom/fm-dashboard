...
import { saveEventCost } from "./actions";

export function EventCostInput({ eventId, currentValue }: { eventId: string; currentValue: number }) {
  ...
  function handleSave() {
    ...
    startTransition(async () => {
      await saveEventCost(eventId, num);
      setSaved(true);
